...
DistFileDir = 'C:/HadoopPig/workspace/HadoopPig/works/output/GAMIFICATION/TranseVerb/part-r-00000'
SeqFileDir = 'C:/HadoopPig/workspace/HadoopPig/works/output/GAMIFICATION/sessionBuy/part-r-00000'
...
def calcurateWeight(verbs,seq,accuDist,sigma):
    ...
    outfp = open('C:/Users/n_shimada/Desktop/ContributionRateForCV.txt','w')
    for rname in verbs:
